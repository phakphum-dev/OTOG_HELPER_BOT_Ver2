...
VER = "Beta 2.0.0"
DEBUG_CHANNEL = 691644349758308423
ANN_CHANNEL = 691618323468779532
CON_ANN_CHANNEL = DEBUG_CHANNEL#691575760674226217
ANN_TITLE = ":loudspeaker:@everyone:loudspeaker:\n"

CON_1DAY = "ทุกๆคนน\nอีก `1 วัน` จะมีคอนเทส!!\n%s"
CON_1HOUR = "ทุกๆคนน\nอีก `1 ชั่วโมง` จะมีคอนเทส!!\n%s"
CON_FUNNY_Q = ["わくわく","เตรียมตัวให้พร้อมมม","เตรียมคีย์บอร์ดและ #include ให้พร้อม","เตรียมตัวเปิดตัว IDE คู่ใจได้เลย"]
CON_END = "@everyon **TIME'S UP!!**\nหมดเวลาแล้วครับ\n%s"#TODO:don't forget @everyone
CON_END_Q = ["ยกมือขึ้นครับ!!!","ส่งอาหารได้แล้วครับ","มาดูผลกันครับ","ถือว่าทุกคนทำเต็มที่แล้วนะครับ เก่งมากๆครับ"]

HELLO_TEXT = ["สวัสดีเจ้า","สวัสดีจ้า","สวัสดีครับ","สวัสดีค่ะ","ສະບາຍດີ","Annyeonghaseyo","Kon'nichiwa","Hello","привет!","ว่าไง",";w;?","Meow Meooww?",":wave:","https://giphy.com/gifs/capoo-halloween-3ov9k0OmfNYeLdK4gg","Nǐ hǎo"]
